    ...
    touch: function(e) {
      ...
      for(var i=0;i<touches.length;i++) {
        ...
        for(var stageIdx=0;stageIdx < touchStage.length;stageIdx++) {
          ...
          var identity = touch.identifier || 0;
          ...
          if(obj && !this.touchedObjects[obj]) {
            ...
            obj.trigger('touch', this.activeTouches[identity]);
            break;
          }
